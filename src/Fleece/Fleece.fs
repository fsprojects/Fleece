...
type GetCodec with
    ...
    static member GetCodec (_: 'Encoding when 'Encoding :> IEncoding and 'Encoding : struct, _: IDefault4, _, _: 'Operation) = Ok <-> id : Codec<'Encoding, 'Encoding>
